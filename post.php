        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p><a href="create.php" class="btn btn-success">Create Project</a>
                <button type="button" class="btn btn-danger">View Project</button></p> 
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p><a href="create.phpp" class="btn btn-success">Add Project</a>
                <button type="button" class="btn btn-danger">View Project</button></p>  
            </div>
          </div>
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p><a href="create.php" class="btn btn-success">Add Project</a>
                <button type="button" class="btn btn-danger">View Project</button></p> 
          </div>
        </div>
              ...
              <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                <div class="col p-4 d-flex flex-column position-static">
                  ...
                  <p class="card-text mb-auto"><?php 
                        echo $n;
                        ?></h3></p>
                  <a href="#" class="stretched-link">Check it out</a>
                </div>
