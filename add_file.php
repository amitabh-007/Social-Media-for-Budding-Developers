...
<div class="container-fluid my-5 ">
       ...
       &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<label>Project Cover Image</label>&nbsp;&nbsp;
        ...
        &emsp;<button class ='btn2' type="submit" name="update">update</button><br><br>
        </form>
        &emsp;&emsp;&emsp;&emsp;&emsp;
        <form method="POST"  enctype="multipart/form-data">
        <label  >For Every Snapshot Mention Caption</label>
        <hr>
        ...
        &emsp;&emsp; &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<button class ='btn2' type="submit" name="sub">Submit</button><br>
        </form>
